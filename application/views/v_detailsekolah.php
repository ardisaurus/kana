      ...
      <?php if ($this->session->flashdata('warning')) {?>
        ...
        <div id="modalubah" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalubahLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <form id="ubah-lembaga" class="form-horizontal" action="<?php echo site_url('sekolah/ubahlembaga');?>" method="post">
                            <div class="controls">
                        ...
                        <div class="modal-body">
                          <form id="tambah-admin" class="form-horizontal" action="<?php echo site_url('sekolah/ubahkota');?>" method="post">
                            <div class="controls">
                              <input type="hidden" id="id_lembaga" name="id_lembaga" value="<?php echo $datalembaga[0]->id_lembaga; ?>">
                            </div>
        ...
        ?>
          ...
          <div class="widget widget-table action-table">
            <div class="widget-header"> <i class="icon-user"></i>
              <h3>Daftar Jurusan <?php echo $datalembaga[0]->nama; ?></h3>
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
                  ...
                  <tr>
                    ...
                    <td> 
                      ...
                      <div id="modalubah<?php echo $jurusan->id_jurusan; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalubahLabel<?php echo $jurusan->id_jurusan; ?>" aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <form id="tambah-admin" class="form-horizontal" action="<?php echo site_url('sekolah/ubahjurusan');?>" method="post">
                            <div class="controls">
                      ...
                      <div id="modalhapus<?php echo $jurusan->id_jurusan; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalhapusLabel<?php echo $jurusan->id_jurusan; ?>" aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <form id="tambah-admin" class="form-horizontal" action="<?php echo site_url('sekolah/hapusjurusan');?>" method="post">
                            <div class="controls">
                              <input type="hidden" id="id_jurusan" name="id_jurusan" value="<?php echo $jurusan->id_jurusan; ?>">
                            </div>
                            <div class="controls">
          ...
          <?php } ?>
            ...
            <div id="modaltambah" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modaltambahLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                <form id="tambah-admin" class="form-horizontal" action="<?php echo site_url('sekolah/tambahjurusan');?>" method="post">
                  <label class="control-label" for="nama">Nama</label>
                  <div class="controls">
                    <input type="text" id="nama" name="nama">                    
                    <input type="hidden" id="id_lembaga" name="id_lembaga" value="<?php echo $datalembaga[0]->id_lembaga; ?>">
                    <input type="hidden" id="jenis" name="jenis" value="0">
                  </div>                  
                </div>
                <div class="modal-footer">
                  <button class="btn" data-dismiss="modal" aria-hidden="true">Batal</button>
