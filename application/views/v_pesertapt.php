        ...
        <?php if ($this->session->flashdata('message')) { ?>
          ...
          <div class="widget widget-table action-table">
            <div class="widget-header"> <i class="icon-th-list"></i>
              <h3>Daftar Peserta dari Perguruan Tinggi</h3>
            </div>
            <!-- /widget-header -->
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="td-actions"><a href="<?php echo site_url("pesertapt/detail/$peserta->id_peserta");?>" class="btn btn-small btn-info"><i class="btn-icon-only icon-eye-open"> </i></a><a href="#modalhapus<?php echo $peserta->id_peserta; ?>" role="button" class="btn btn-small btn-danger" data-toggle="modal"><i class="icon-remove"></i></a></td>
                    ...
                    <div id="modalhapus<?php echo $peserta->id_peserta; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalhapusLabel<?php echo $peserta->id_peserta; ?>" aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <form id="tambah-admin" class="form-horizontal" action="<?php echo site_url('pesertapt/hapuspeserta');?>" method="post">
                            <div class="controls">
          ...
          <!-- /widget -->
            <div align="right">
              ...
              <!-- Button to trigger modal -->
                 <a href="<?php echo site_url('pesertapt/formtambah');?>" role="button" class="btn btn-success"><i class="icon-plus"></i> Tambah</a>
              </div>
              <?php if ($datapeserta) { ?>
