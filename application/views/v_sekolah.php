      ...
      <?php if ($this->session->flashdata('warning')) {?>
        ...
        <?php if ($this->session->flashdata('message')) { ?>
            ...
            <?php 
             ...
             ?>
                <form id="edit-profile" class="form-horizontal" action="<?php echo site_url('sekolah/cari');?>" method="post">
                  <div class="control-group" align="right">                                           
                    <div class="controls">
                      <div class="input-append">
                        <input class="span2 m-wrap" id="appendedInputButton" name="nama" id="nama" type="text" placeholder="Nama Sekolah">
            ...
            <?php }else{ ?>
                <form id="edit-profile" class="form-horizontal" action="<?php echo site_url('sekolah/cari');?>" method="post">
                  <div class="control-group" align="right">                                           
                    <div class="controls">
                      <div class="input-append">
                        <input class="span2 m-wrap" id="appendedInputButton" value="<?php echo $this->session->userdata('namasekolah'); ?>" type="text" disabled>
                        <a href="<?php echo site_url('sekolah');?>" class="btn btn-danger" ><i class="icon-remove"></i></a>
                        </form>
                      </div>
                    </div>  <!-- /controls -->      
                  </div> <!-- /control-group -->
              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> 
                      <div align="right">
                        <a href="<?php echo site_url("sekolah/detaillembaga/$pendidikan->id_lembaga");?>" role="button" class="btn-small btn-info"><i class="icon-align-justify"></i> Detail</a>                         
                      ...
                      <div id="modalhapus<?php echo $pendidikan->id_lembaga; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalhapusLabel<?php echo $pendidikan->id_lembaga; ?>" aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <form id="tambah-admin" class="form-horizontal" action="<?php echo site_url('sekolah/hapuslembaga');?>" method="post">
                            <div class="controls">
          ...
          <!-- /widget -->
            ...
            <div id="modaltambah" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modaltambahLabel" aria-hidden="true">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h3 id="modaltambahLabel">Tambah Sekolah</h3>
              </div>
              <div class="modal-body">
                <form id="tambah-admin" class="form-horizontal" action="<?php echo site_url('sekolah/tambahsekolah');?>" method="post">
