          ...
          <div class="span12">          
            ...
            <div class="widget ">
              ...
              <div class="widget-header">
                <i class="icon-user"></i>
                <h3>Peserta Baru dari Sekolah</h3>
            </div> <!-- /widget-header -->
          
          <div class="widget-content">
                       
                <?php echo form_open_multipart('pesertasekolah/tambah', 'class="form-horizontal" role="form"'); ?>
                  <fieldset>
                    ...
                    <div class="form-actions">
                      ...
                      <a href="<?php echo site_url('pesertasekolah');?>" class="btn">Batal</a>
                    </div> <!-- /form-actions -->
                  </fieldset>
                </form>
