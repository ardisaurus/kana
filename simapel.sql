...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2017 at 03:01 PM
...
INSERT INTO `jurusan` (`id_jurusan`, `nama`, `id_lembaga`, `jenis`) VALUES
(5, 'Teknik Komputer Jaringan', 9, 0),
(6, 'Teknik Listrik', 9, 0),
(7, 'Teknik Elektro', 10, 0),
(8, 'Administrasi', 10, 0),
(9, 'Multimedia', 11, 0),
(10, 'Rekayasa Perangkat Lunak', 11, 0),
(11, 'Teknologi Informasi', 12, 0),
(12, 'Teknik Elektro', 12, 0),
(13, 'Teknik', 13, 1),
(14, 'Ilmu Pendidikan', 13, 1);
...
INSERT INTO `pembimbing` (`id_pembimbing`, `nama`, `id_divisi`) VALUES
(4, 'Ramdhan', 5),
(5, 'Abdul', 6),
(6, 'Ramli', 7),
(7, 'Sabrina', 7);
...
INSERT INTO `pendidikan` (`id_lembaga`, `nama`, `alamat`, `jenis`, `id_kota`, `id_propinsi`) VALUES
(9, 'SMK 1 Malang', 'Jln. Utara no 11', 0, '3507', '35'),
(10, 'SMK 2 Malang', 'Jln. Timur no. 9', 0, '3573', '35'),
(11, 'SMK 3 Malang', 'Jln. Barat no. 11', 0, '3507', '35'),
(12, 'Politeknik Negeri Malang', 'Jln. Timur no. 1', 1, '3507', '35'),
(13, 'Unversitas Negeri Malang', 'Jln. Barat no. 11', 1, '3507', '35');
...
INSERT INTO `peserta` (`id_peserta`, `ni`, `id_lembaga`, `id_jurusan`, `waktu_mulai`, `waktu_selesai`, `id_divisi`, `id_pembimbing`, `nama`) VALUES
(9, 147777, 9, 5, '2017-01-18', '2017-04-18', 5, 4, 'SALMA'),
(11, 1777243, 10, 8, '2017-07-10', '2017-08-10', 6, 5, 'ADINDA'),
(12, 160017, 12, 12, '2017-08-16', '2017-09-13', 6, 5, 'GINA'),
(13, 158277, 13, 13, '2017-09-18', '2017-10-22', 5, 4, 'SILVIA'),
(14, 1601112, 12, 11, '2017-11-18', '2018-01-11', 5, 4, 'PUTRI'),
(15, 137357, 11, 10, '2017-01-18', '2017-04-18', 7, 6, 'VESA'),
(18, 137377, 11, 10, '2017-03-18', '2017-04-18', 7, 6, 'VIKA'),
(25, 137377, 11, 10, '2017-03-18', '2017-04-18', 7, 6, 'SAVIKA'),
(27, 137377, 12, 11, '2017-03-18', '2017-04-18', 7, 6, 'VIKA');
...
INSERT INTO `surat` (`id_surat`, `no_surat_keluar`, `tgl_surat_keluar`, `no_surat_masuk`, `tgl_surat_masuk`, `kepada`) VALUES
(2, '122/112/as/2017', '2013-08-05', '1jaj/112/tt/2017', '2019-07-15', 'Kepala Jurusan Teknik Informatika'),
(6, '1322/1112/awa/2017', '2017-01-02', '1jj/112/tt/2017', '2017-02-02', 'Kepala sekolah SMKN 1 Malang'),
(7, '144/121/aba/2017', '2017-02-01', '1dd/112/jo/2017', '2017-03-02', 'Kepala sekolah SMKN 1 Malang');

-- --------------------------------------------------------

--
-- Table structure for table `suratpeserta`
--

CREATE TABLE IF NOT EXISTS `suratpeserta` (
  `idsuratpeserta` int(11) NOT NULL AUTO_INCREMENT,
  `id_peserta` int(11) NOT NULL,
  `no_surat_keluar` varchar(100) NOT NULL,
  PRIMARY KEY (`idsuratpeserta`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=20 ;

--
-- Dumping data for table `suratpeserta`
--

INSERT INTO `suratpeserta` (`idsuratpeserta`, `id_peserta`, `no_surat_keluar`) VALUES
(12, 12, '1322/1112/awa/2017'),
(13, 14, '1322/1112/awa/2017'),
(14, 27, '1322/1112/awa/2017'),
(18, 27, '122/112/as/2017'),
(19, 14, '122/112/as/2017');
...
('ichijo@raku.com', '0192023a7bbd73250516f069df18b500', 'ichijo'),
('onodera@kosaki.com', '0192023a7bbd73250516f069df18b500', 'onodera');
